	...
	if (deathmatch->value || coop->value)
	{
		...
		if (attacker && attacker->client)
		{
			...
			case MOD_TELEFRAG:
				...
				break;
			case MOD_TRANQUILIZER: // outputs message when killed by, should i add to top of the list?
...
void ClientBeginDeathmatch (edict_t *ent)
{
	...
	gi.centerprintf(ent, "Welcome, Dont get your ass handed to you!\n Last one to stay awake wins.\n");
